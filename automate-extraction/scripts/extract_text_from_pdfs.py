...
def extract_text_from_pdfs():
    ...
    # Directory for saving the extracted text files
    ...
    for file in os.listdir(pdf_dir):
        if file.endswith('.pdf'):
            ...
            pypdf_output_file = os.path.join(output_dir, f"{base_file_name}_pypdf.json")
            unstructured_output_file = os.path.join(output_dir, f"{base_file_name}_unstructured.json")
            ...
            try:
                ...
                unstructured_text = partition_pdf(filename=file)
